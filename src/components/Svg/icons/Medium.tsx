...
const Icon: React.FC<GithubProps> = ({ isDark, ...props }) => {
  ...
  return (
    <Svg viewBox="0 0 50 49" {...props}>
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M1 16.9301C1 8.13216 8.13216 1 16.9301 1C25.7281 1 32.8603 8.13216 32.8603 16.9301C32.8603 25.7281 25.7281 32.8603 16.9301 32.8603C8.13216 32.8603 1 25.7281 1 16.9301Z" stroke="url(#paint0_linear_211_9969)" stroke-width="0.5"/>
      <g clip-path="url(#clip0_211_9969)">
