  ...
  return (
    <Svg viewBox="0 0 50 49" {...props}>
      <svg width="33" height="34" viewBox="0 0 33 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M0.279297 16.9301C0.279297 8.13216 7.41146 1 16.2094 1C25.0074 1 32.1396 8.13216 32.1396 16.9301C32.1396 25.7281 25.0074 32.8603 16.2094 32.8603C7.41146 32.8603 0.279297 25.7281 0.279297 16.9301Z" stroke="url(#paint0_linear_211_9966)" strokeWidth="0.5" />
